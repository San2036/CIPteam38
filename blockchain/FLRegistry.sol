...
contract FLRegistry {
    ...
    function updateTrustAgent(address newTrustAgent) external onlyTrustAgent {
        trustAgent = newTrustAgent;
    }
    ...
    function isNodeRegistered(address nodeAddr) external view returns (bool) {
        return nodes[nodeAddr].nodeAddress != address(0);
    }
}
